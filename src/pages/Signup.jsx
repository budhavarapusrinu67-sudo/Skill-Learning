...
export default function Signup() {
    ...
    const saveUserProfile = async (fbUser, name) => {
        try {
            if (!db) return; // Database might not be initialized
                ...
                <div className="flex flex-col p-10 md:p-20 relative overflow-hidden h-full">
                    <div className="grow flex flex-col justify-center">
                        <div className="flex flex-col gap-8">
                            ...
                            <Link to="/login" className="btn-outline w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-black text-slate-600 border-slate-100 hover:border-indigo-100 group">
