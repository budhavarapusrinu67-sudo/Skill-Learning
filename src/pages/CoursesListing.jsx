                                ...
                                <div className="flex flex-wrap lg:flex-col gap-3">
                                    {categories.map(cat => (
                                        <button
                                            ...
                                            className={`px-4 py-2.5 rounded-xl text-left text-sm font-bold transition-all duration-200 flex items-center justify-between group ${selectedCategory === cat
                        ...
                        <AnimatePresence mode="popLayout">
                            {filteredCourses.length > 0 ? (
                                ...
                                >
                                    ...
                                    <p className="text-slate-500 max-sm font-medium">
