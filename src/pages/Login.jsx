...
export default function Login() {
    ...
    return (
        ...
        >
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-0 overflow-hidden rounded-[4rem] shadow-2xl border border-slate-100 bg-white min-h-[700px]">
                ...
                <div className="hidden lg:flex flex-col gap-12 p-20 bg-linear-to-br from-indigo-700 to-indigo-900 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col gap-16 h-full justify-between">
                        ...
                        <div className="flex flex-col gap-8">
                            <h2 className="text-5xl font-black leading-tight">Welcome <span className="text-indigo-300">Back</span> to the Future of <span className="text-indigo-300 underline underline-offset-8">Learning</span>.</h2>
                            <p className="text-indigo-100 text-lg opacity-80 max-w-sm font-medium">Log in to continue your journey and access your saved progress, certificates, and community.</p>
                        </div>
                        ...
                        <div className="flex items-center gap-4 bg-slate-900/20 backdrop-blur-md p-6 rounded-3xl border border-white/5">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] leading-relaxed text-indigo-100 border-l border-white/10 pl-6"> Your data is encrypted and secure with our enterprise-grade security protocols. </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grow flex flex-col justify-center">
                        <div className="flex flex-col gap-8">
                            <div className="flex flex-col gap-3">
                                <h3 className="text-3xl font-black text-slate-900">Sign <span className="text-indigo-600">In</span></h3>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                                ...
                                >
                                    {isProcessing ? (
                                        ...
                                        <><LogIn size={24} /> Log In to Platform</>
                                    )}
                                </button>
                            </form>
                            ...
                            <div className="relative flex items-center justify-center pt-2">
                                ...
                                <span className="relative z-10 bg-white px-4 text-xs font-black uppercase tracking-widest text-slate-300">Or connect with</span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <button
                                    ...
                                    className="btn-outline w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-black text-slate-700 border-slate-200 hover:bg-slate-50 transition-all"
                                >
                                    {isGoogleProcessing ? (
                            ...
                            <div className="mt-8 pt-8 border-t border-slate-50 text-center">
                                ...
                                <Link to="/signup" className="text-indigo-600 font-black flex items-center justify-center gap-2 group">
                                    Create Student Profile <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
                                </Link>
                            </div>
                        </div>
                    </div>
